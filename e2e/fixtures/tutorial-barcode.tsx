...
function Fixture() {
  ...
  </form><label><input type="checkbox" aria-label="Keep customer" /> Keep customer</label><h2>Add product</h2><BarcodeInput label="Product barcode" value={barcode} onChange={setBarcode} onScan={setBarcode} /><p>Stored barcode: {barcode}</p><HelpCenter userId="tutorial-barcode-fixture-v1" /></main>;
}
