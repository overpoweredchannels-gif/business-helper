...
const fixture = ["entry-navigation", "meeting-followup", "tutorial-barcode", "setup-import"].includes(process.env.TRADEOS_FIXTURE_NAME) ? process.env.TRADEOS_FIXTURE_NAME : "sales-access";
