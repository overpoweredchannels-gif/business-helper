...
export function BusinessRecordsExport() {
  ...
  return <section className="mb-4 rounded border bg-card p-4">
    <strong>Export business records</strong><p className="text-sm text-muted-foreground">Choose any date range to review transactions, payments, stock movements and recorded activity, then save as PDF.</p>
