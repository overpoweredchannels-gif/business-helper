// TradeOS ERP — Categories Import Config

import type { EntityImportConfig, ImportFieldDef } from "../types";

export const categoriesImportConfig: EntityImportConfig = {
  ...
  fields: [
    { key: "name", label: "Category Name", type: "text", required: true, unique: true, preview: true, width: 200, help: "Required. Unique." } satisfies ImportFieldDef,
  ...
  export: {
    filenamePrefix: "categories_export",
    columns: [
