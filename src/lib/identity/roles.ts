...
const BUILT_IN_ROLES: Record<BuiltInRole, RoleDefinition> = {
  ...
  salesman: {
    ...
    permissions: ["location_view", "field_sales"],
    isBuiltIn: true,
    createdAt: "",
  },
  purchase_officer: {
  ...
  delivery_rider: {
    id: "delivery_rider",
    name: "Delivery Rider",
    description: "Deliver goods, view assigned route, confirm deliveries.",
    permissions: [
      "sales_view",
      "inventory_view",
      "customers_view",
  ...
  field_officer: {
    id: "field_officer",
    name: "Field Officer",
    description: "Record customer visits, feedback, and field sales orders.",
    permissions: ["location_view", "field_sales"],
    isBuiltIn: true,
    createdAt: "",
  },
  collection_officer: {
    ...
    description: "Record cash collections, cheques, and bank transfers from customers.",
    permissions: [
      "customers_view",
      "payments_manage",
      "sales_view",
  ...
  supervisor: {
    id: "supervisor",
    name: "Supervisor",
    description: "Monitor salesmen, review field activity, and approve draft sales.",
    permissions: [
      "sales_view",
      "sales_create",
      "sales_manage",
